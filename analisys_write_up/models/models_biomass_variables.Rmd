...
```{r}
summary(mixed_models$totalbiom)
```
...
```{r}
#AIC model
AIC(mixed_models$totalbiom)


# model R2
r2(mixed_models$totalbiom)
...
(plot_totalbiom <- 
  masomenos_plot_no_lines(data = data_totalbiom_plot,xvar = xvar, yvar = yvar, 
                 tvar = tvar, color = treatment,n_treat = 5,
                 ucl = UCL, lcl = LCL) +
...
```{r}
#AIC model
AIC(mixed_models$above_biom)

# model R2
r2(mixed_models$above_biom)
...
```{r}
#AIC model
AIC(mixed_models$below_biom)


# model R2
r2(mixed_models$below_biom)
...
#AIC model
AIC(mixed_models$root_dry_weight)

# model R2
r2(mixed_models$root_dry_weight)
```
...
#AIC model
AIC(mixed_models$stem_dry_weight)

# model R2
r2(mixed_models$stem_dry_weight)
...
```{r}
#AIC model
AIC(mixed_models$whole_leaf_dry_weight)

# model R2
r2(mixed_models$whole_leaf_dry_weight)
