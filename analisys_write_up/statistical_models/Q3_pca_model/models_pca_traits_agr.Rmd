...
```{r}
number_of_nodule <- read.table("~/Documents/projects/shade_house_experiment/data/raw_data/1_nodule_data_with_zeros.csv", header=TRUE, sep=",", strip.white=TRUE)

```
```{r}
JOIN TO INCULDE NUMBER OF NODULES VER SI TIENE SENTIDO
```
